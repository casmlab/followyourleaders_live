	...
	def update_leaders(self,num_tweets_shown):
		...
		for leader in leaders:
			...
			if time_item != None:
				...
				collection_leaders.update({'_id': leader['_id']},{'$set': {'followers': followers, 'friends':friends, 'description':description, "recent_tweets": {[a[0] for a in date_index]: {'created_at': [a[1] for a in date_index], 'tweet_text':[a[0] for a in text_index]}}}})
